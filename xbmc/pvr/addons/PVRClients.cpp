...
bool CPVRClients::HasSerieManualTimerSupport(int iClientId)
{
  PVR_CLIENT client;
  if (GetConnectedClient(iClientId, client))
    return client->SupportsSerieManualTimers();

  return false;
}

bool CPVRClients::HasSkipRepeatingTimersSupport(int iClientId)
{
  PVR_CLIENT client;
  if (GetConnectedClient(iClientId, client))
    return client->SupportsSkipRepeatingTimers();
