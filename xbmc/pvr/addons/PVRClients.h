...
namespace PVR
{
  ...
  public:
     ...
     * @brief Check whether a client supports timers.
     * @param iClientId The id of the client to check.
     * @return True if supports repeating manual timers, false otherwise.
     */
    bool HasSerieManualTimerSupport(int iClientId);

    /*!
     * @brief Check whether a client supports timers.
     * @param iClientId The id of the client to check.
     * @return True if supports the 'skip repeating shows', false otherwise.
     */
    bool HasSkipRepeatingTimersSupport(int iClientId);
