...
extern "C" {
  ...
  typedef enum
  {
    PVR_TIMERTYPE_UNKNOWN           =  0, /*!< @brief timer type for a unknown timer schedule */
    PVR_TIMERTYPE_MANUAL_ONCE       = -1, /*!< @brief timer type for a once time manual timer  */
    PVR_TIMERTYPE_EPG_ONCE          = -2, /*!< @brief timer type for a once time epg based timer */
    PVR_TIMERTYPE_MANUAL_REPEATING  = -3, /*!< @brief timer type for a manual timer schedule */
  } PVR_TIMERTYPEID;
  ...
  {
    int              iTypeId;              /*!< @brief (required) this type's identifier, should only contain numbers > 0! */
